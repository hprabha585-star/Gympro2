...
const Gym = sequelize.define('Gym', {
  ...
  // This gym's OWN plans / discounts / UPI id / default fees — kept
  // completely separate from the owner's primary gym (User.gymData) and
  // from every other additional gym, so switching gyms never shows or
  // saves data belonging to a different branch.
